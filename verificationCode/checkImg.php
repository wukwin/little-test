...
<div>
<form Action="checkImg.php" method="post">
<h1 style="text-align:center;">网站登录后台</h1>
	...
	<p>验证码：<img id="change" border="1" src="verificationCode.php?r=<? echo rand(); ?>"  /></p>	
	<p><input type="text" name="autocode" /></p>
	<p><a href="javascript:;" onclick="document.getElementById('change').src='verificationCode.php?r='+Math.random()">换一个</a></p>
